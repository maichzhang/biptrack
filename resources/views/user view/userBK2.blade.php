...
<body>
    ...
    <div id="sidebar">
        ...
        <div class="dropdown">
            <button class="dropdown-toggle" onclick="toggleDropdown('dropdown-menu-1')">BIS (B 7003 EUA)</button>
        ...
        <div class="inner">
            <a href="{{ route('userBK2') }}"> <img src="{{ asset('images/logo.png') }}" alt="Logo bipol" class="logo"></a>
            <hr>
        </section>
