...
<body>
    ...
    <div id="pesan">
        ...
        <div class="dropdown">
            <button class="dropdown-toggle" onclick="toggleDropdown('dropdown-menu-1')">BIS (B 7005 EPA)</button>
        ...
        <div class="inner">
            <a href="{{ route('userbis2') }}"> <img src="{{ asset('images/logo.png') }}" alt="Logo bipol" class="logo"></a>
            <hr>
